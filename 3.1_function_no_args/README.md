...
[Заготовка домашнего задания](https://repl.it/@Lopinopulos/PB-31-Zadaniie-3-Funktsii)


### Процесс реализации

1. Откройте [заготовку домашнего задания](https://repl.it/@Lopinopulos/PB-31-Zadaniie-3-Funktsii). Всю работу нужно вести в файле `scripts.js`
