...
4. Создайте одну функцию, которая будет выводить в консоль следующие настойки:
    * заголовок,
    * спискок настроек,
    * нижнее меню,
    * информация о версии программы.
5. Между строками текста должна быть пустая строка.
6. Вызовите функцию из п.4, убедитесь, что печать правильная. Должен быть всего один вызов функции.
